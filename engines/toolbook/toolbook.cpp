		...
		case 0x21: case 0x22: case 0x23: {
			...
			if (id == 8) {
				...
				if (selector.number == 0x401c) {
					...
					//
					// Имена классов и типы блоков кучи — разные нумерации, поэтому
					// сопоставлены только те, что подтверждены: тип блока совпадает с
					// аргументом класса у builtin 182, а объекты диалога дали
					// 0x09 — кнопку, 0x0a — поле, 0x15 — картинку. Остальные типы
